                    ...
                    <div className="row">
                        <div className="col-md-12 col-md-offset-0">
                            <ul className="timeline">
                                <li className="timeline-heading text-center animated fadeInUp">
                                    <div><h3>Work Experience</h3></div>
                                </li>
                                <li className="animated fadeInUp timeline-unverted">
                                ...
                                <li className="timeline-inverted animated fadeInUp">
                                    <div className="timeline-badge"><i className="icon-suitcase"></i></div>
                                    <div className="timeline-panel">
                                        <div className="timeline-heading">
